...
const respuestaConProductos = false

// Si la promesa se cumple -> Uso el resolve
...
console.log(promesaObtenerProductos)
// then(), catch(), finally()
...
/* promesaObtenerProductos
    ...
    }) // El finally() se va a ejecutar siempre, tanto si se ejecuta el then() como el catch() */

// async y await (ES8)
// convierto una función sincrónica a asincrónica usando la palabra async
// await siempre va de la mano del async
const obtenerProductos = async () => {
//  la promesa esta en estado pending -> fulfilled o reject
    try {
        //THEN
